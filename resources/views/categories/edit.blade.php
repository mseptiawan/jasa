<x-app-layout>
    <div class="container mx-auto py-6 max-w-2xl">
        <div class="bg-white p-8 rounded-lg border border-gray-200 shadow-sm">
            ...
            <p class="text-gray-600 mb-6">Isi formulir di bawah untuk {{ isset($category) ? 'mengubah' : 'menambahkan' }}
                kategori.</p>
            ...
            <form action="{{ isset($category) ? route('categories.update', $category->id) : route('categories.store') }}"
                ...
                <div class="flex justify-end gap-3 mt-6">
                    <a href="{{ route('categories.index') }}"
                       class="px-5 py-2 border border-gray-300 rounded-lg text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 transition">
                        Batal
                    </a>
                    <button type="submit"
                            class="px-5 py-2 bg-black text-white font-semibold rounded-lg hover:bg-indigo-700 transition focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">

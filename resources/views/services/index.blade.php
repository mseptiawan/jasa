<x-app-layout>
    ...
    <style>
        ...
        .blur-background {
            ...
            pointer-events: none; /* Mencegah interaksi dengan konten di belakang modal */
        }
                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full bg-white rounded-lg overflow-hidden">
                            <thead class="bg-gray-100">
                                <tr>
                                    <th class="px-6 py-3 text-left text-sm font-semibold text-gray-600 uppercase tracking-wider">Judul</th>
                                    <th class="px-6 py-3 text-left text-sm font-semibold text-gray-600 uppercase tracking-wider">Harga</th>
                                    <th class="px-6 py-3 text-left text-sm font-semibold text-gray-600 uppercase tracking-wider">Kategori</th>
                            ...
                            <tbody class="divide-y divide-gray-200">
                                ...
                                <tr class="hover:bg-gray-50 transition-colors duration-150">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600">{{ $service->subcategory->name ?? '-' }}</td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium flex items-center space-x-2">
                                        {{-- Ikon Lihat --}}
                                        <a href="{{ route('services.show', $service->slug) }}" class="text-gray-500 hover:text-gray-700 transition-colors duration-200" title="Lihat">
                                        ...
                                        {{-- Ikon Edit --}}
                                        <a href="{{ route('services.edit', $service->slug) }}" class="text-gray-500 hover:text-gray-700 transition-colors duration-200" title="Edit">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                        ...
                                        <form action="{{ route('services.destroy', $service->slug) }}"
                                            ...
                                            @csrf
                                            @method('DELETE')
                                            <button type="button" class="text-gray-500 hover:text-red-600 transition-colors duration-200 delete-button" title="Hapus">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
            ...
            <div class="mt-3 text-center">
                <div class="mx-auto flex items-center justify-center h-12 w-12 rounded-full bg-red-100">
                    <svg class="h-6 w-6 text-red-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.013 21H7.987a2 2 0 01-1.92-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"></path>
                    </svg>
                </div>
                ...
                <div class="items-center px-4 py-3 mt-4">
                    <button id="closeModalButton" class="px-4 py-2 bg-gray-200 text-gray-800 text-base font-medium rounded-md hover:bg-gray-300 focus:outline-none transition duration-150 ease-in-out">
                        Batal
                    </button>
                    <button id="confirmDeleteButton" class="px-4 py-2 ml-2 bg-red-600 text-white text-base font-medium rounded-md hover:bg-red-700 focus:outline-none transition duration-150 ease-in-out">
                        Hapus
                    </button>
                </div>
            </div>

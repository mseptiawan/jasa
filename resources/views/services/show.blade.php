<x-app-layout>
    ...
    <div class="container mx-auto p-4 md:p-8 max-w-7xl">
        ...
        <div class="bg-white p-6 rounded-xl border border-gray-200 grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    {{-- Rating dan Ulasan (Ringkasan Rating global sudah ada di sini, tapi detail ulasan per individu belum) --}}
        ...
        {{-- START: Ulasan Pelanggan (Logika yang dikembalikan) --}}

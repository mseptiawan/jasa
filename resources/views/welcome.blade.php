...
<head>
    ...
    {{-- Link CSS Swiper dari dashboard.blade.php --}}
    <link rel="stylesheet"
    ...
    <style>
        ...
        /* Search styling DARI dashboard.blade.php */
        .search-container {
            position: relative;
            display: flex;
            align-items: center;
        ...
        .search-container input {
            /* Penting: Memberi ruang untuk ikon pencarian */
            padding-right: 3rem;
        ...
        /* Styling tombol lokasi terdekat yang di dashboard.blade.php menggunakan padding y-3 */
        .btn-location-submit {
            padding-top: 0.75rem;
            /* py-3 */
...
<body class="text-gray-800">
    ...
    <header class="sticky top-0 z-40 bg-white/90 backdrop-blur-sm w-full border-b border-gray-200">
        <div class="max-w-7xl mx-auto flex flex-wrap justify-between items-center py-3 px-4 sm:px-6 lg:px-8 gap-4">
            ...
            <div class="w-full md:w-auto md:flex-1 md:max-w-md lg:max-w-lg order-3 md:order-2">
                {{-- Area ini dikosongkan karena form search dipindahkan ke bawah banner --}}
            </div>
        </div>
    </header>
    ...
    @php
        ...
        // Tambahkan fallback untuk $services jika belum didefinisikan
        if (!isset($services)) {
            $services = collect([]);
        }
        ...
        $categories = [
            ...
            (object) ['id' => 3, 'name' => 'Writing & Translation'],
            (object) ['id' => 4, 'name' => 'Video & Animation'],
            (object) ['id' => 5, 'name' => 'Programming & Tech'],
            (object) ['id' => 6, 'name' => 'Perbaikan Elektronik'],
            (object) ['id' => 7, 'name' => 'Jasa Akademik'],
            (object) ['id' => 8, 'name' => 'Konsultasi & Lainnya'],
        ];

        // Ikon Kategori (Sama dengan dashboard.blade.php)
        $categoryIcons = [
            'Graphics & Design' =>
            ...
            'default' =>
                '<svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="currentColor" viewBox="0 0 24 24"><path d="M4 6h16M4 12h16M4 18h16" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>',
        ];
    @endphp
        ...
        <main>
            <div class="bg-white p-6 rounded-lg border border-gray-200 mb-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    {{-- START: Search berdasarkan Kata Kunci (Disesuaikan dengan dashboard.blade.php) --}}
                    ...
                    {{-- END: Search berdasarkan Kata Kunci --}}
                    ...
                    <form id="location-form"
                        ...
                        <div class="flex items-center gap-2">
                            <div class="relative flex-grow">
                                {{-- Input ini sudah disamakan tingginya via CSS global #address-input --}}
                                <input type="text"
                                       id="address-input"
                            ...
                            <button type="submit"
                                    class="bg-primary text-white font-bold px-4 rounded-lg shadow-md hover:opacity-90 transition-all flex items-center justify-center btn-location-submit">
                                <svg xmlns="http://www.w3.org/2000/svg"
                                     width="20"
                                     height="20"
                                     viewBox="0 0 24 24"
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                        @foreach ($highlightServices as $service)
                            @php
                                ...
                                $mainImage =
                                    !empty($images) && count($images) > 0 ? asset('storage/' . $images[0]) : null;
                                $profilePhoto =
    ...
    <script>
        // Inisialisasi Swiper (Sama dengan dashboard.blade.php)
        ...
        document.addEventListener('DOMContentLoaded', () => {
            // --- JS for Modal, Geolocation and Autocomplete ---
            ...
            // Autocomplete alamat (Sama dengan dashboard.blade.php)
            ...
            // --- Infinite Scroll Logic (Disesuaikan dengan dashboard.blade.php) ---
            const normalServiceCards = document.querySelectorAll('.normal-service-card');
            const loadingIndicator = document.getElementById('loading-indicator');

            const cardsPerLoad = 8; // Disesuaikan dengan dashboard.blade.php
            let currentlyDisplayed = cardsPerLoad;
            // isLoading sudah didefinisikan di atas
            ...
            const loadMoreCards = () => {
                ...
                // Simulate a network delay (1 second as in dashboard.blade.php)
                setTimeout(() => {
    ...
    {{-- Memanggil komponen footer (diasumsikan sudah didefinisikan) --}}

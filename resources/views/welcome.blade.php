...
<head>
    ...
    <style>
        ...
        /* Custom Colors (Sama dengan dashboard.blade.php) */
        .bg-primary {
...
<body class="text-gray-800">
    ...
    <div class="container mx-auto p-4 md:p-8 max-w-7xl">
        ...
        @php
            // PERBAIKAN SINTAKS: Semua data dummy diletakkan di sini
            $banners = [
                ['image' => 'banner-pertama.png', 'link' => '/login', 'alt' => 'Promo Spesial Awal Bulan'],
                ['image' => 'banner-kedua.png', 'link' => '/service/apply', 'alt' => 'Layanan Terpopuler Minggu Ini'],
            ];
            ...
            // Filter layanan dummy (menggunakan data dummy dari $services)
        ...
        {{-- START: Widget Sapaan (Statik) --}}
        <div class="mb-6">
            <h1 class="text-2xl font-black text-gray-900">Selamat Datang!</h1>
            <p class="text-xl text-primary font-extrabold">Temukan Jasa yang Anda Butuhkan</p>
        </div>
        {{-- END: Widget Sapaan --}}
        ...
        {{-- START: Layanan Paling Populer (TAMBAHAN DUMMY) --}}
    ...
    {{-- Script CDN Swiper (Disalin dari dashboard.blade.php) --}}
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            // --- Variabel Elemen Search & Modal Umum ---
            ...
            if (addressInputWelcome) {
                addressInputWelcome.addEventListener('input', () => {
                    clearTimeout(geocodeTimeout);
                    const query = addressInputWelcome.value.trim();
                    if (query.length < 3) {
                        ...
                        fetch(
                            ...
                            .then(data => {
                                ...
                                if (data.length > 0) {
                                    ...
                                    resultsListWelcome.style.display = 'block';
                                } else {
                                    resultsListWelcome.style.display = 'none';
                                }
                            })
